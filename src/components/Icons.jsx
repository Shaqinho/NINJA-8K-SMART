...
export const Icons = {
  ...
  Tv: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="15" rx="2"/><polyline points="17 2 12 7 7 2"/></svg>,
  Film: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/></svg>,
  Popcorn: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 22h10l1-10H6l1 10z"/><path d="M5.5 12a2.5 2.5 0 0 1 0-5 3.5 3.5 0 0 1 6.5-2 3.5 3.5 0 0 1 6.5 2 2.5 2.5 0 0 1 0 5"/></svg>,
  ...
  Info: () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>,
};

export const CopyButton = ({ onClick, copied }) => (
  <button onClick={onClick} className="text-gray-500 active:scale-90 transition-all hover:text-gray-400">
    {copied ? <div className="w-4 h-4 text-green-400"><Icons.Check/></div> : <div className="w-4 h-4"><Icons.Copy/></div>}
  </button>
);
