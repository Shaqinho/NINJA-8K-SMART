...
// ============================================================================
// PLAYLIST — Main page (replaces LandingPage)
// ============================================================================
const Playlist = ({ onNavigateToPlayer }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col w-full h-full items-center justify-center gap-5">
        
        {/* Logo — centered */}
        <h1 
          onClick={handleLogoClick}
          className="text-white text-3xl font-black italic tracking-tighter cursor-pointer select-none active:scale-95 transition-transform"
        >
          NINJA <span style={{ color: PARTICLE_THEME_COLORS[particleTheme] }}>8K</span>
        </h1>

        {/* PlaylistDiv — landscape layout */}
        <PlaylistDiv
